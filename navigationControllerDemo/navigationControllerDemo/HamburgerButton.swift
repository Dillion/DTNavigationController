...
public class HamburgerButton: UIButton {
    ...
    private let middleYPosition: CGFloat = 8
    private let bottomYPosition: CGFloat = 14
    ...
    public var showsMenu: Bool = true {
        didSet {
            ...
            topRotation.values = rotationValuesFromTransform(top.transform,
                endValue: showsMenu ? CGFloat(-M_PI - M_PI_4*13/16) : CGFloat(M_PI + M_PI_4*13/16))
            ...
            bottomRotation.values = rotationValuesFromTransform(bottom.transform,
                endValue: showsMenu ? CGFloat(-M_PI_2 - M_PI_4*19/16) : CGFloat(M_PI_2 + M_PI_4*19/16))
